...
const Skeleton = (option: any) => {
  return (
    <ContentLoader backgroundColor="#dadada" style={{ width: '100%', height: '105px' }} {...option}>
      <rect width="60" height="60" rx="4" ry="4" />
      <rect width="60" height="16" rx="4" ry="4" x="70" y="0" />
      <rect width="60" height="16" rx="4" ry="4" x="70" y="20" />
      <rect width="60" height="16" rx="4" ry="4" x="70" y="36" />
    </ContentLoader>
  );
};
